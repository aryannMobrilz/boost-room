...
import { Table, OrderKey, Info, Button } from './NewOrdersTable.style';

const columns = () => [
  {
    title: 'Order info',
    dataIndex: 'order',
    render({ id, game, date, seller, service, price }: Record<string, any>) {
      return (
        <>
          <OrderKey>
          ...
          <OrderKey>
            Buyer: <Info color="sky-blue">{seller}</Info>
          </OrderKey>
          <OrderKey>
