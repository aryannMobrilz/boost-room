...
import paypalSVG from '@/assets/icons/payment-methods/paypal.svg';
import payoneerSVG from '@/assets/icons/payment-methods/payoneer.svg';
import skrillSVG from '@/assets/icons/payment-methods/skrill.svg';
import payopSVG from '@/assets/icons/payment-methods/payop.svg';
import applePaySVG from '@/assets/icons/payment-methods/apple-pay.svg';
import trustpilotSVG from '@/assets/icons/trustpilot.svg';
import googleSafeBrowsingSVG from '@/assets/icons/google-safe-browsing.svg';
import comodoSecurePNG from '@/assets/images/comodo-secure.png';
